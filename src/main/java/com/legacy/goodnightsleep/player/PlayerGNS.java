...
{	
	...
	public void teleportPlayer(boolean shouldSpawnPortal) 
	{
		...
		if (this.player instanceof EntityPlayerMP)
		{
			...
			scm.transferPlayerToDimension(player, transferToID, new TeleporterGNS(FMLCommonHandler.instance().getMinecraftServerInstance().worldServerForDimension(transferToID)));
		}
	}
