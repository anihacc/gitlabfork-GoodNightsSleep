package com.legacy.goodnightsleep.test;
...
import com.legacy.goodnightsleep.GNSHooks;
...
public class DimensionType
{
	...
	public static final Codec<DimensionType> DIRECT_CODEC = null;
	private static final int MOON_PHASES = 8;
	public static final float[] MOON_BRIGHTNESS_PER_PHASE = new float[] { 1.0F, 0.75F, 0.5F, 0.25F, 0.0F, 0.25F, 0.5F, 0.75F };
	public static final ResourceKey<net.minecraft.world.level.dimension.DimensionType> OVERWORLD_LOCATION = ResourceKey.create(Registry.DIMENSION_TYPE_REGISTRY, new ResourceLocation("overworld"));
	public static final ResourceKey<net.minecraft.world.level.dimension.DimensionType> NETHER_LOCATION = ResourceKey.create(Registry.DIMENSION_TYPE_REGISTRY, new ResourceLocation("the_nether"));
	public static final ResourceKey<net.minecraft.world.level.dimension.DimensionType> END_LOCATION = ResourceKey.create(Registry.DIMENSION_TYPE_REGISTRY, new ResourceLocation("the_end"));
	...
	public static final ResourceKey<net.minecraft.world.level.dimension.DimensionType> OVERWORLD_CAVES_LOCATION = ResourceKey.create(Registry.DIMENSION_TYPE_REGISTRY, new ResourceLocation("overworld_caves"));
	...
	public static final Codec<Supplier<net.minecraft.world.level.dimension.DimensionType>> CODEC = null; // RegistryFileCodec.create(Registry.DIMENSION_TYPE_REGISTRY,
																											// DIRECT_CODEC);
	...
	{
		GNSHooks.initBuiltinDimensionTypes(p_63927_);
		WritableRegistry<net.minecraft.world.level.dimension.DimensionType> writableregistry = p_63927_.ownedRegistryOrThrow(Registry.DIMENSION_TYPE_REGISTRY);
