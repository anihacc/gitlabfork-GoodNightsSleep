...
public class ItemsGNS
{
	...
	public static ArmorMaterial CANDY_ARMOR = EnumHelper.addArmorMaterial("CANDY_ARMOR", "candy", 7, new int[]{1, 2, 2, 1}, 5);
	public static ArmorMaterial RAINBOW_ARMOR = EnumHelper.addArmorMaterial("RAINBOW_ARMOR", "rainbow", 22, new int[]{2, 6, 5, 2}, 14);
	public static ArmorMaterial POSITITE_ARMOR = EnumHelper.addArmorMaterial("POSITITE_ARMOR", "positite", 49, new int[]{3, 8, 6, 3}, 10);
	public static ArmorMaterial NECRUM_ARMOR = EnumHelper.addArmorMaterial("NECRUM_ARMOR", "necrum", 5, new int[]{2, 3, 3, 2}, 0);
	public static ArmorMaterial ZITRITE_ARMOR = EnumHelper.addArmorMaterial("ZITRITE_ARMOR", "zitrite", 15, new int[]{3, 7, 6, 3}, 0);
	public static ArmorMaterial NEGATITE_ARMOR = EnumHelper.addArmorMaterial("NEGATITE_ARMOR", "negatite", 33, new int[]{4, 9, 7, 4}, 0);
	...
	private static Item register(String unlocalizedName, Item item)
	{
		...
		GameRegistry.registerItem(item.setRegistryName(VariableConstants.locate(unlocalizedName)));
