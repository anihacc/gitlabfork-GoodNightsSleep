	 ...
	 public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	    {
	        ...
	        else
	        {
	            ...
	            if (player.canPlayerEdit(pos, facing, itemstack) && player.canPlayerEdit(blockpos, facing, itemstack))
	            {
	                ...
	                {
	                    IBlockState iblockstate2 = BlocksGNS.luxurious_bed.getDefaultState().withProperty(BlockGNSBed.FACING, enumfacing).withProperty(BlockGNSBed.PART, BlockGNSBed.EnumPartType.FOOT);
	                    ...
	                    if (tileentity instanceof TileEntityLuxuriousBed)
	                    {
	                    ...
	                    if (tileentity1 instanceof TileEntityLuxuriousBed)
	                    {
	                    	//((TileEntityGNSBed)tileentity).setType(true);;
	                    }
