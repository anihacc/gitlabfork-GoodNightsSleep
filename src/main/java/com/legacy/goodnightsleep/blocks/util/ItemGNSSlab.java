...
public class ItemGNSSlab extends ItemBlock
{
    ...
    public ItemGNSSlab(Block block, BlockSlab singleSlab, BlockSlab doubleSlab)
    {
        super(block);
    ...
    public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        if (stack.stackSize != 0 && playerIn.canPlayerEdit(pos.offset(facing), facing, heldItem))
        {
            ...
            return this.tryPlace(playerIn, heldItem, worldIn, pos.offset(facing)) ? EnumActionResult.SUCCESS : super.onItemUse(stack, playerIn, worldIn, pos, hand, facing, hitX, hitY, hitZ);
        }
        else
        {
