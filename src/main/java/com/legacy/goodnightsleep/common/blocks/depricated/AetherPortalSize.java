...
public class AetherPortalSize 
{
    ...
    protected int calculatePortalHeight()
    {
        ...
        for (this.height = 0; this.height < 21; ++this.height)
        {
            for (int i = 0; i < this.width; ++i)
            {
                ...
                if (block == BlocksGNS.test_portal)
                {
    ...
    {
        return blockIn.getDefaultState().getMaterial() == Material.AIR || blockIn == Blocks.FIRE || blockIn == BlocksGNS.test_portal;
    }
    ...
    public void placePortalBlocks()
    {
        for (int i = 0; i < this.width; ++i)
        {
            ...
            {
                this.world.setBlockState(blockpos.up(j), BlocksGNS.test_portal.getDefaultState().withProperty(BlockAetherPortal.AXIS, this.axis), 2);
            }
        }
    }
