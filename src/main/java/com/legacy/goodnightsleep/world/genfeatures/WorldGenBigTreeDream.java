...
public class WorldGenBigTreeDream extends WorldGenerator
{
	...
	void genTreeLayer(int x, int y, int z, float par4, byte par5, Block par6)
	{	
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
		{
			...
			while (var13 <= var7)
			{
				...
				else
				{
					...
					{
						this.world.setBlock(var11[0], var11[1], var11[2], par6); //Blocks.AIR
						++var13;
					}
				}
			}
	...
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block par3)
	{
		...
		if (var4[var6] != 0)
		{
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
			{
				...
				this.world.setBlock(var14[0], var14[1], var14[2], par3);
			}
		}
	}
	...
	void generateTrunk()
	{
		...
		this.placeBlockLine(var5, var6, BlocksGNS.dream_log);
		if (this.trunkSize == 2)
		{
			++var5[0];
			++var6[0];
	...
	void generateLeafNodeBases()
	{
		...
		for (int[] var3 = new int[] { this.basePos[0], this.basePos[1], this.basePos[2] }; var1 < var2; ++var1)
		{
			...
			{
				this.placeBlockLine(var3, var5, BlocksGNS.dream_log);
			}
		}
	}
	...
	boolean validTreeLocation()
	{
		...
		if (var3 != BlocksGNS.dream_grass && var3 != BlocksGNS.dream_dirt)
		{
			return false;
		}
		else
