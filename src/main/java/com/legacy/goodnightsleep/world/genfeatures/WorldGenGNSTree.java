...
public class WorldGenGNSTree extends WorldGenTrees
{
            ...
            else
            {
                ...
                if (this.canGrowInto(state.getBlock()))
                {
                        ...
                        for (int k1 = position.getX() - j1; k1 <= position.getX() + j1; ++k1)
                        {
                            ...
                            for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2)
                            {
                                ...
                                if (Math.abs(l1) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0)
                                {
                                    ...
                                    if (state.getBlock().isAir(worldIn, blockpos) || state.getBlock().isLeaves(worldIn, blockpos) || state.getBlock().getMaterial() == Material.vine)
                                    {
                    ...
                    for (int j3 = 0; j3 < i; ++j3)
                    {
                        ...
                        if (state.getBlock().isAir(worldIn, upN) || state.getBlock().isLeaves(worldIn, upN) || state.getBlock().getMaterial() == Material.plants || state.getBlock().getMaterial() == Material.vine)
                        {
    ...
    {
        Material material = blockType.getDefaultState().getBlock().getMaterial();
