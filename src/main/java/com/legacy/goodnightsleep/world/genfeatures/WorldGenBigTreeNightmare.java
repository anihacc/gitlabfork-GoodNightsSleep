...
public class WorldGenBigTreeNightmare extends WorldGenerator
{
	...
	public WorldGenBigTreeNightmare(boolean par1)
	{
		super(par1);
	}
	...
	void genTreeLayer(int par1, int par2, int par3, float par4, byte par5, Block state)
	{
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
		{
			...
			while (var13 <= var7)
			{
				...
				else
				{
					...
					if (var14 != Blocks.air && var14 != BlocksGNS.diamond_leaves)
					{
						++var13;
					}
					else
					{
						this.world.setBlock(var11[0], var11[1], var11[2], state);
						++var13;
					}
				}
			}
	...
	void generateLeafNode(int par1, int par2, int par3)
	{
		...
		for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4)
		{
			...
			this.genTreeLayer(par1, var4, par3, var6, (byte) 1, BlocksGNS.diamond_leaves);
		}
	}

	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block state)
	{
		...
		if (var4[var6] != 0)
		{
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
			{
				...
				this.world.setBlock(var14[0], var14[1], var14[2], state);
				
				//this.func_76485_a(this.worldObj, new BlockPos(var14[0], var14[1], var14[2]), state);
			}
		}
	}
	...
	void generateTrunk()
	{
		...
		this.placeBlockLine(var5, var6, BlocksGNS.dead_log);
		if (this.trunkSize == 2)
		{
			++var5[0];
			++var6[0];
	...
	void generateLeafNodeBases()
	{
		...
		for (int[] var3 = new int[] { this.basePos[0], this.basePos[1], this.basePos[2] }; var1 < var2; ++var1)
		{
			...
			{
				this.placeBlockLine(var3, var5, BlocksGNS.dead_log);
			}
		}
	}
	...
	int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
	{
		...
		else
		{
			...
			for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
			{
				...
				if (var16 != Blocks.air && var16 != BlocksGNS.diamond_leaves)
				{
					break;
				}
			}
	...
	boolean validTreeLocation()
	{
		...
		if (var3 != BlocksGNS.nightmare_grass && var3 != Blocks.air)
		{
			return false;
		}
		else
