...
public class GoodDreamDimension extends Dimension
{
	...
	public ChunkGenerator<?> createChunkGenerator()
	{
		...
		return ChunkGeneratorType.SURFACE.create(this.world, BiomeProviderType.FIXED.create(BiomeProviderType.FIXED.createSettings(this.world.getWorldInfo()).setBiome(GNSBiomes.GOOD_DREAM_PLAINS)), genSettings);
	}
