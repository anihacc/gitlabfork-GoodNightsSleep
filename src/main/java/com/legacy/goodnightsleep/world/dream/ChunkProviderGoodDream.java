...
public class ChunkProviderGoodDream implements IChunkProvider
{
    ...
    /*public void replaceBlocksForBiome(int x, int z, Block[] p_147422_3_, byte[] p_147422_4_, BiomeGenBase[] p_147422_5_)
	{
		...
		for (int var8 = 0; var8 < 16; var8++)
		{
			for (int var9 = 0; var9 < 16; var9++)
			{
				...
				Block topBlock = BlocksGNS.dream_grass;
				Block fillerBlock = BlocksGNS.dream_dirt;
				
				for (int var16 = 127; var16 >= 0; var16--)
				{
					 if (var16 <= 0 + this.random.nextInt(5))
					 {
						 chunkPrimer.setBlockState(var8, var16, var9, Blocks.bedrock);
					 }
					 else
					 {
