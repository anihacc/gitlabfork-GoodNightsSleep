...
public class BigHopeMushroomFeature extends Feature<NoFeatureConfig>
{
	...
	public boolean func_212245_a(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, NoFeatureConfig p_212245_5_)
	{
		...
		if (j >= 1 && j + i + 1 < 256)
		{
			...
			if (!Block.isDirt(block) && block != BlocksGNS.dream_grass_block)
			{
				return false;
			}
			else
			{
				...
				IBlockState iblockstate1 = BlocksGNS.hope_mushroom_block.getDefaultState().with(BlockHugeMushroom.DOWN, Boolean.valueOf(false));
