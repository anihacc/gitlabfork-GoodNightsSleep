...
public class GNSBigTreeFeature extends AbstractTreeFeature<NoFeatureConfig>
{
	...
	private void makeFoliage(IWorld p_208525_1_, int p_208525_2_, BlockPos p_208525_3_, List<GNSBigTreeFeature.FoliageCoordinates> p_208525_4_)
	{
	...
	private void makeBranches(Set<BlockPos> p_208524_1_, IWorld p_208524_2_, int p_208524_3_, BlockPos p_208524_4_, List<GNSBigTreeFeature.FoliageCoordinates> p_208524_5_)
	{
	...
	private int checkLocation(Set<BlockPos> p_208528_1_, IWorld world, BlockPos pos, int p_208528_4_)
	{
		...
		{
			int i = this.makeLimb(p_208528_1_, world, pos, pos.up(p_208528_4_ - 1), false);
			if (i == -1)
			{
				return p_208528_4_;
			}
