...
public class GNSGenMinable extends WorldGenerator
{
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (world.getBlockState(newPos).getBlock() == BlocksGNS.delusion_stone || world.getBlockState(newPos).getBlock() == Blocks.STONE))
                                {
