...
public class WorldGenBigTreeNightmare extends WorldGenerator
{
	...
	void genTreeLayer(int par1, int par2, int par3, float par4, byte par5, IBlockState state)
	{
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
		{
			...
			while (var13 <= var7)
			{
				...
				else
				{
					...
					{
						this.world.setBlockState(new BlockPos(var11[0], var11[1], var11[2]), state);
						++var13;
					}
				}
			}
	...
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, IBlockState state)
	{
		...
		if (var4[var6] != 0)
		{
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
			{
				...
				this.world.setBlockState(new BlockPos(var14[0], var14[1], var14[2]), state);
	...
	void generateTrunk()
	{
		...
		this.placeBlockLine(var5, var6, BlocksGNS.dead_log.getDefaultState());
		if (this.trunkSize == 2)
		{
			++var5[0];
			++var6[0];
	...
	void generateLeafNodeBases()
	{
		...
		for (int[] var3 = new int[] { this.basePos[0], this.basePos[1], this.basePos[2] }; var1 < var2; ++var1)
		{
			...
			{
				this.placeBlockLine(var3, var5, BlocksGNS.dead_log.getDefaultState());
			}
		}
	}
	...
	boolean validTreeLocation()
	{
		...
		if (var3 != BlocksGNS.nightmare_grass.getDefaultState() && var3 != Blocks.AIR.getDefaultState())
		{
			return false;
		}
		else
