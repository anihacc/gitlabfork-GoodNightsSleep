package com.legacy.goodnightsleep.world.features.dream;
...
public class MapGenDreamCaves extends MapGenBase
{
    ...
    protected boolean canReplaceBlock(IBlockState state, IBlockState state2)
    {
        if (state.getBlock() == Blocks.STONE)
        {
            return true;
        }
        else if (state.getBlock() == BlocksGNS.delusion_stone)
        {
            return true;
        }
        else if (state.getBlock() == BlocksGNS.dream_dirt)
        {
            return true;
        }
        ...
        else if (state.getBlock() == BlocksGNS.nightmare_grass)
        {
            return true;
        }
        else if (state.getBlock() == BlocksGNS.dream_grass)
        {
            return true;
        }
