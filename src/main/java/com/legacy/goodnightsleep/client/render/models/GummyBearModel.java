...
public class GummyBearModel<T extends Entity> extends ListModel<T>
{
	...
	public GummyBearModel()
	{
		...
		this.Snout = new ModelPart(this, 28, 0);
		...
		this.rightarm = new ModelPart(this, 24, 13);
		...
		this.leftarm = new ModelPart(this, 24, 13);
		...
		this.leftleg = new ModelPart(this, 24, 22);
		...
		this.rightleg = new ModelPart(this, 24, 22);
		...
		this.leftear = new ModelPart(this, 0, 26);
		...
		this.rightear = new ModelPart(this, 0, 26);
		...
		this.belly = new ModelPart(this, 28, 6);
