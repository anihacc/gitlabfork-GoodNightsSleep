...
@OnlyIn(Dist.CLIENT)
public class TileEntityStrangeBedRenderer extends TileEntityRenderer<TileEntityStrangeBed>
{
	...
	public void render(TileEntityStrangeBed tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage)
	{
		if (destroyStage >= 0)
		{
