...
public class ModelUnicorn<T extends Entity> extends EntityModel<T>
{
    ...
    private final RendererModel newBody;
    ...
    public ModelUnicorn()
    {
        ...
        this.horn = new RendererModel(this, 119, 0);
        this.horn.setRotationPoint(0.0F, 4.0F, -10.0F);
        this.horn.addBox(-1.0F, -16.0F, 2.0F, 2, 7, 2, 0.0F);
        this.newBody = new RendererModel(this, 0, 34);
        this.newBody.setRotationPoint(0.0F, 11.0F, 9.0F);
        this.newBody.addBox(-5.0F, -8.0F, -19.0F, 10, 10, 24, 0.0F);
    }
    ...
    public void render(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        boolean flag2 = abstracthorse instanceof AbstractChestedHorseEntity;
        boolean flag3 = !flag && flag2 && ((AbstractChestedHorseEntity)abstracthorse).hasChest();
        float f1 = 1.0F;
