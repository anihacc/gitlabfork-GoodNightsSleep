...
{	
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (nightmare)
        {
        	...
        	this.drawCenteredString(this.fontRendererObj, "You dream of horrible things...", this.width / 2, this.height / 2 - 50, 16777215);
        }
        else
        {
        	//this.mc.getTextureManager().bindTexture(DREAM_BACKGROUND);
        	this.drawCenteredString(this.fontRendererObj, "You dream of peaceful lands...", this.width / 2, this.height / 2 - 50, 16777215);
        }
