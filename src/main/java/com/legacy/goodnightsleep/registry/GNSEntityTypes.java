...
public class GNSEntityTypes
{
	...
	public static final EntityType<GummyBearEntity> GUMMY_BEAR = buildEntity("gummy_bear", EntityType.Builder.<GummyBearEntity>of(GummyBearEntity::new, MobCategory.CREATURE).sized(0.6F, 0.7F));
	...
	public static final EntityType<HerobrineEntity> HEROBRINE = buildEntity("herobrine", EntityType.Builder.of(HerobrineEntity::new, MobCategory.MONSTER));
